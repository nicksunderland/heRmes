...
| Phenotype 2 | Ischaemic HF     | HF comorbid with antecedent MI/revascularisation        |
...
| CongHD | HF   | MI    | CABG   | PCI   | Thrombolysis | Category                | Phenotype |
|--------|------|-------|--------|-------|--------------|-------------------------|-----------|
| TRUE   | ANY  | ANY   | ANY    | ANY   | ANY          | Exclude                 |           |
| FALSE  | TRUE | TRUE  | ANY    | ANY   | ANY          | (Ischaemic) HF case     |1 & 2      |
| FALSE  | TRUE | FALSE | TRUE   | ANY   | ANY          | (Ischaemic) HF case     |1 & 2      |
| FALSE  | TRUE | FALSE | FALSE  | TRUE  | ANY          | (Ischaemic) HF case     |1 & 2      |
| FALSE  | TRUE | FALSE | FALSE  | FALSE | TRUE         | (Ischaemic) HF case     |1 & 2      |
| FALSE  | TRUE | FALSE | FALSE  | FALSE | FALSE        | (Non-ischaemic) HF case |1 & 3      |
| FALSE  | FALSE| TRUE  | ANY    | ANY   | ANY          | Exclude                 |           |
| FALSE  | FALSE| FALSE | TRUE   | ANY   | ANY          | Exclude                 |           |
| FALSE  | FALSE| FALSE | FALSE  | TRUE  | ANY          | Exclude                 |           |
| FALSE  | FALSE| FALSE | FALSE  | FALSE | TRUE         | Exclude                 |           |
| FALSE  | FALSE| FALSE | FALSE  | FALSE | FALSE        | CONTROL                 |           |
...
\* Myocardial infarction and revascularisation exclusion should be made based on codes appearing prior to the DCM / NICM inclusion codes - i.e. excluding antecedent ischaemic events but allowing ischaemic events that happen after the DCM / NICM diagnosis.  
