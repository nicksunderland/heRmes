...
Output formatting can be change by altering the inputs. If the phenotype IDs are named, these names are used as column names in the result. The overall result is given in the column `overall`, although this can be renamed by giving the `name` parameter.   
